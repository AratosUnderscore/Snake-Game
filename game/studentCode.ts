...
export class BoardHelper implements IBoardHelper {
    ...
    createApple(freeCells: Coordinate[]): CellItem {
        ...
        return new CellItem(freeCells[Math.floor(Math.random() * 98)], './game-assets/peach.png');
    }
...
export class Snake implements ISnake {
    protected snakeHead = new CellItem(new Coordinate(5, 5), './game-assets/snaaket_body.png');
    protected snakeBody: CellItem[] = [new CellItem(new Coordinate(4, 5), './game-assets/saaket.png'), new CellItem(new Coordinate(3, 5), './game-assets/snaaket_body.png')];
    ...
    update(direction: Direction): void {
        ...
        this.snakeBody.unshift(new CellItem(new Coordinate(oldX, oldY), './game-assets/snaaket_body.png'));
